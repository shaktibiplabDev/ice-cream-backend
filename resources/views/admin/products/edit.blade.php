            ...
            <div class="form-grid">
                ...
                <div class="form-field">
                    ...
                    <select name="category" class="form-select" required>
                        ...
                        <option value="Frozen Desserts" {{ old('category', $product->category) == 'Frozen Desserts' ? 'selected' : '' }}>Frozen Desserts</option>
                        <option value="Sorbet" {{ old('category', $product->category) == 'Sorbet' ? 'selected' : '' }}>Sorbet</option>
                        <option value="Gelato" {{ old('category', $product->category) == 'Gelato' ? 'selected' : '' }}>Gelato</option>
                        <option value="Frozen Yogurt" {{ old('category', $product->category) == 'Frozen Yogurt' ? 'selected' : '' }}>Frozen Yogurt</option>
                    </select>
